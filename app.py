...
st.markdown("""
    ...
    /* 기존 스타일 유지 */
    div[data-testid="column"] > div > div > div[data-testid="stVerticalBlock"] { gap: 3px !important; }
    div[data-testid="stVerticalBlockBorderWrapper"] { margin-bottom: 2px !important; }
